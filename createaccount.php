              ...
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <form action="backend/createaction.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="UserEmail" class="text-left">Email</label>
                      <input type="email" class="form-control" id="UserEmail" name="UserEmail" placeholder="Email">
                    </div>
                    <div class="form-group">
                      <label for="UserFirstName" class="text-left">First Name</label>
                      <input type="text" class="form-control" id="UserFirstName" name="UserFirstName" placeholder="First Name">
                    </div>
                    <div class="form-group">
                      <label for="UserLastName" class="text-left">Last Name</label>
